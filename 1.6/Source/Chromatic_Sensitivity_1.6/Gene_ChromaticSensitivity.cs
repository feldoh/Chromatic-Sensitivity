...
public class Gene_ChromaticSensitivity : Gene
{
    ...
    {
        base.Tick();
        if (!pawn.Spawned || !pawn.IsHashIntervalTick(GenTicks.TickLongInterval) || Rand.Chance(0.75f) || GetHediff() != null)
        {
            return;
        }
    ...
    {
        return pawn.health.hediffSet.GetFirstHediffOfDef(ChromaticDefOf.Taggerung_ChromaticSensitivity);
    }
