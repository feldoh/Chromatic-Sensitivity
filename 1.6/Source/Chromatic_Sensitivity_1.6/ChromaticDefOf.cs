...
public static class ChromaticDefOf
{
    ...
    public static ThoughtDef Taggerung_FavoriteChromaticSurroundings;
    public static ThoughtDef Taggerung_FavoriteChromaticBedroom;
    public static ThoughtDef Taggerung_FavoriteChromaticBed;

    static ChromaticDefOf()
    {
        DefOfHelper.EnsureInitializedInCtor(typeof(ChromaticDefOf));
    }
}
