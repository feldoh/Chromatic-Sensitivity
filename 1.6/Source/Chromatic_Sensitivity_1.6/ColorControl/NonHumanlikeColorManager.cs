...
internal class NonHumanlikeColorManager : IColorManager
{
    private readonly IGraphicHandler _graphicHandler;

    public NonHumanlikeColorManager()
        : this(null) { }
    ...
    {
        if (pawn.RaceProps.Humanlike || pawn.health.hediffSet.GetFirstHediffOfDef(ChromaticDefOf.Taggerung_ChromaticSensitivity) is not Hediff_ChromaticSensitivity hediff)
        {
            return false;
        }
